...
var Select = function (_Component) {
    ...
    function Select(props, context) {
        ...
        _this.itemClick = function (value, text) {
            _this.setState({
                value: value,
                text: text
            });
            if (_this.props.onSelected) {
                _this.props.onSelected(value, text);
            }
        };

        _this.getList = function (value) {
            var text = '';
            var dom = (_this.props.children || []).map(function (item) {
                if (item.type.name === 'Option') {
                    if (value === item.props.value) {
                        text = item.props.children;
                    }
                    return _react2.default.cloneElement(item, { selectBridge: _this.itemClick });
                }
            });
...
var Option = function (_Component2) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'li',
                { sign: 'item', onClick: function onClick() {
