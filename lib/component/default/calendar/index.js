...
var Calendar = function (_Component) {
    ...
    function Calendar(props, context) {
        ...
        _this.setMomentLocal(_this.props.lang || 'zh');
    ...
    _createClass(Calendar, [{
        ...
        key: 'setMomentLocal',
        value: function setMomentLocal(lang) {
            switch (lang) {
                case 'zh':
                    _moment2.default.locale('zh-cn');
                    break;
                case 'en':
                    _moment2.default.locale('en-au');
                    break;
            }
        }
        /**
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.compareDateFull = function (date) {
        var timerConfig = _this3.props.timerConfig;
        ...
        if (timerConfig === false) {
            ...
            var hourHide = timerConfig.hourHide,
                minuteHide = timerConfig.minuteHide,
                secondHide = timerConfig.secondHide;
        ...
        return _this3.compareDate(date, type);
    };

    this.getValid = function (date) {
        var valid = true;
        if (date) {
            if (_this3.compareDateFull(date) === 0) {
...
Calendar.propTypes = _defineProperty({
