...
var _initialiseProps = function _initialiseProps() {
    ...
    this.getTreeItem = function (data, first, last) {
        ...
        var props = Object.assign({}, _this2.props, { data: data, first: first, last: last, opened: !!data['opened'], value: _this2.state.value });
        return _react2.default.createElement(
            _treeItem2.default,
            _extends({}, props, { onTextClick: _this2.itemClick }),
    ...
    this.itemClick = function (value, id, text, data) {
        var flag = true;
        if (_this2.props.onTextClick) {
            flag = _this2.props.onTextClick(value, id, text, data);
        } else {
            flag = true;
        }
        if (flag) {
