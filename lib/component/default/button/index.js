    ...
    _createClass(Button, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'button',
                { className: styleType + ' ' + (this.props.loading || this.props.disabled ? 'disabled' : '') },
...
Button.propTypes = {
    styleType: _propTypes2.default.string, //with-icon
    loading: _propTypes2.default.bool,
    disabled: _propTypes2.default.bool
};

exports.default = (0, _logical2.default)(Button, _logic2.default, _config2.default);