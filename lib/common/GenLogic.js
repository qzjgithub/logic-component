...
var GenLogic = function () {
    ...
    function GenLogic(object) {
        ...
        if (_Util2.default.isKVObjectWithStringKey(object)) {
            ...
            this._status.forEach(function (s, key) {
                _this._status.set(key, new _Status2.default(_Util2.default.isKVObject(s) ? s : {}));
                _this._values.set(key, _this._status.get(key).defaultState);
            });
        }
    }
    ...
    _createClass(GenLogic, [{
        ...
        value: function addMotivation(name, _ref) {
            ...
            this._motivation.set(name, new _Motivation2.default(status, trigger));
        }
        ...
        value: function deleteStatus(name) {
            ...
            try {
                for (var _iterator2 = this._motivation.keys()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function setStatusMotivation(motivation, status, type) {
            ...
            var m = this._motivation.get(motivation);
            var _iteratorNormalCompletion3 = true;
            var _didIteratorError3 = false;
            var _iteratorError3 = undefined;

            try {
                for (var _iterator3 = Object.keys(m.status)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var sk = _step3.value;
