...
var logical = function logical(WrappedComponent, logic) {
    ...
    return _temp = _class = function (_WrappedComponent) {
            ...
            value: function genStatusRelate(sign, props) {
                ...
                data['list'].forEach(function (v, k) {
                    ...
                    seq.events.push(function (ev) {
                        ...
                        info['oldEvent'] && (_info$oldEvent = info['oldEvent']).call.apply(_info$oldEvent, [_this5].concat([ev, oldValue, newValue, info['status']])); //执行原组件传入的方法
                    ...
                    seq.events.push(function (info, oldValue, newValue) {
                        ...
                        _this5.setState({
                            ...
                            var onChanged = _this5.props['onChanged']; //检测并调用onchange方法
        ...
        this.getBone = function (bone) {
            var children = _this8.bone = bone;
            if (!_this8.logic.status.size) {
                return children;
            } else {
                _this8.genSignKv(_this8.logic.status);
                var props = _this8.genStatusRelate(_Status2.default.BASIC, children.props);

                props['children'] = _this8.genChildren(children.props.children);
                props = _this8.checkProps(props);
                ...
                status.event.forEach(function (value, event) {
                    ...
                    switch (value) {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            sts[state] = !!value.call(_this8, _this8.state);
                    }
                });
