...
var logical = function logical(WrappedComponent, logic) {
    ...
    return _temp = _class = function (_WrappedComponent) {
        ...
        function _class(props, context) {
            ...
            _this.state = Object.assign({}, _this.state || {}, _this.initKeys(), {
                ...
                data['list'].forEach(function (v, k) {
                    ...
                    seq.events.push(function (ev) {
                        ...
                        if (info['oldEvent']) {
                            ...
                            var eValue = (_info$oldEvent = info['oldEvent']).call.apply(_info$oldEvent, [_this5].concat([ev, oldValue, newValue, info['status']])); //执行原组件传入的方法
